...
## functions do
## the two functions caches the inverse of a matrix to reduce the cost of repeate computation
# specially when dealing with big matrices

## Write a short comment describing this function

## This fuction creats a special matrix that is actually a list containing  
# a function to 
